...
/**
 * Radix handles the parts hand-rolled modals in this app were missing: focus is trapped inside
 * the dialog, Escape closes it, the page behind is inert, and screen readers announce it.
 */
